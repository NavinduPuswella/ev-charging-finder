...
export default function AdminOverview() {
    ...
    const kpis: KPI[] = [
        { label: "Total Stations", value: analytics.totalStations, icon: Building2, color: "text-emerald-600", bgColor: "bg-emerald-50" },
        { label: "Total Bookings", value: analytics.totalBookings, icon: CalendarCheck, color: "text-blue-600", bgColor: "bg-blue-50" },
        { label: "Total Users", value: analytics.totalUsers, icon: Users, color: "text-violet-600", bgColor: "bg-violet-50" },
        { label: "Total Revenue", value: `LKR ${analytics.totalRevenue.toLocaleString()}`, icon: DollarSign, color: "text-rose-600", bgColor: "bg-rose-50" },
    ];
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            <div>
                ...
                <p className="text-muted-foreground mt-1">EV Charging Network at a Glance</p>
            </div>
